...
export const serverMembers = pgTable("server_members", {
  ...
  // streamXp: integer("stream_xp").default(0), // TODO: Add column to database
  // streamLevel: integer("stream_level").default(1), // TODO: Add column to database
  globalLevel: integer("global_level").default(1),
  messageCount: integer("message_count").default(0),
  voiceTime: integer("voice_time").default(0), // in minutes
  // streamTime: integer("stream_time").default(0), // TODO: Add column to database (in minutes)
